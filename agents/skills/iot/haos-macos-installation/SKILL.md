...
- HA host orchestrator: `bootstrap/ha_host/tools/orchestrator/`
- HA host orchestrator command reference: `bootstrap/ha_host/tools/orchestrator/README.md`
...
PYTHONPATH=bootstrap/ha_host/tools/orchestrator/src python3 -m ha_host_orchestrator.entrypoints.host_startup --check-only --no-require-utun
PYTHONPATH=bootstrap/ha_host/tools/orchestrator/src python3 -m ha_host_orchestrator.entrypoints.host_watch --check-only --no-require-utun
