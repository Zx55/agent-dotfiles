...
- Local PS5 add-on source: `bootstrap/ha_host/tools/ps5-ha-bridge/`.
...
```sh
./agents/skills/iot/haos-addons/scripts/status.sh
./agents/skills/iot/haos-addons/scripts/install-samba.sh
./agents/skills/iot/haos-addons/scripts/install-mosquitto.sh
./agents/skills/iot/haos-addons/scripts/install-hacs.sh
./agents/skills/iot/haos-addons/scripts/install-xiaomi-home.sh
./agents/skills/iot/haos-addons/scripts/install-ps5-ha-bridge.sh
```
