---
name: ascii-art
description: Generate ASCII art using pyfiglet, cowsay, boxes, toilet, image-to-ascii tools, remote ASCII APIs, and direct handcrafted output. Use when the user wants stylized text art, banners, terminal visuals, or character-based graphics instead of raster images.
---
